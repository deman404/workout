  ...
  return (
    <>
      ...
      <View style={styles.container}>
        <Image
          source={{
            uri: "https://cdn.muscleandstrength.com/sites/default/files/styles/800x500/public/muscular-guy-doing-cable-flys.jpg?itok=cSCNyLEj",
          ...
          <View style={styles.content}>
            ...
            >
              ...
              <View style={styles.TextView}>
                <Text style={styles.cardTitle}>Advanced workout</Text>
                <View style={styles.btn}>
                  <Text style={styles.exercise}>11 workouts</Text>
                </View>
              </View>
